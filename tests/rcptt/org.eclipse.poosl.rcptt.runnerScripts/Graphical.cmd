...
SET POOSL_PLUGINS=%WORKSPACE%\poosl\org.eclipse.poosl.update\target\repository
SET RESULTS=%WORKSPACE%\results\graphical-tests
...
-import "%TESTS%\org.eclipse.poosl.rcptt;%TESTS%\org.eclipse.poosl.rcptt.graphical" ^
-injection:dir "%POOSL_PLUGINS%" ^
-suites "Editing;Create;Navigation;Graph Debug ClassDiagram;Graph Debug Close;Graph Debug Editing;Graph Communication Elements;Graph Debug ProjectExplorer;Graph Debug Structure Diagram;Graph Debug Textual" ^
-connectTimeout 240 ^
