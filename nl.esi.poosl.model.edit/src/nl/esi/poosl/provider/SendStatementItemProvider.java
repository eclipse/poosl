...
/**
 * This is the item provider adapter for a {@link nl.esi.poosl.SendStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SendStatementItemProvider extends StatementItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SendStatement_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SendStatement_name_feature", "_UI_SendStatement_type"),
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SendStatement_type") :
			getString("_UI_SendStatement_type") + " " + label;
	}
