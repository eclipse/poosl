...
/**
 * This is the item provider adapter for a {@link nl.esi.poosl.Annotation} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class AnnotationItemProvider extends ItemProviderAdapter
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Annotation_name_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Annotation_name_feature", "_UI_Annotation_type"), PooslPackage.Literals.ANNOTATION__NAME, true, false, false,
