...
public class PooslFactoryImpl extends EFactoryImpl implements PooslFactory {
    ...
    public EObject create(EClass eClass) {
        ...
        case PooslPackage.EXPRESSION_SEQUENCE_ROUND_BRACKET:
            return createExpressionSequenceRoundBracket();
        ...
        case PooslPackage.SWITCH_EXPRESSION_CASE:
            return createSwitchExpressionCase();
        ...
        case PooslPackage.ENVIRONMENT_CONSTANT:
            return createEnvironmentConstant();
        ...
        case PooslPackage.STATEMENT_SEQUENCE_ROUND_BRACKET:
            return createStatementSequenceRoundBracket();
        ...
        case PooslPackage.SWITCH_STATEMENT_CASE:
            return createSwitchStatementCase();
