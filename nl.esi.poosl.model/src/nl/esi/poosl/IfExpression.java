...
public interface IfExpression extends Expression {
    ...
    /**
     * Sets the value of the '{@link nl.esi.poosl.IfExpression#getThenClause <em>Then Clause</em>}' containment
    ...
    /**
     * Sets the value of the '{@link nl.esi.poosl.IfExpression#getElseClause <em>Else Clause</em>}' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
