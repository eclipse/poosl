h1. Eclipse Configuration Files for POOSL

This directory contains configuration files for Eclipse which should be installed by every POOSL team member to ensure a common coding style:
...
* @poosl.importorder@: the configuration file to sort the imports. Import it from __Preferences > Java > Code Style > Organize Imports__. *Required for everyone*.
