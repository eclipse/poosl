...
Like Checkstyle, to prevent border effects and to follow modication, configurations are declared
in folder:
...
To generate, use 'DesignGeneration' run configuration.

If you edit directly _org.eclipse.poosl.sirius/description/poosl.odesign_ for test purpose, launch
'DesignReverse' and extract properties from xtend file at 
_org.eclipse.poosl.sirius.tooling/target/rvs_
...
On-fly code modification will be ignored.
====
