...
public final class TypingHelper {
    ...
    public static boolean isCompatible(Resource res, String actualType, String expectedType) {
        if (actualType == null || expectedType == null) {
            ...
            return actualType.equals(expectedType) || HelperFunctions.isReflexiveAncestorData(res, expectedType, actualType) || HelperFunctions.isReflexiveAncestorData(res, actualType, expectedType);
        }
    }
    ...
    public static boolean isSubtype(Resource res, String actualType, String expectedType) {
        if (actualType == null || expectedType == null) {
            ...
            return actualType.equals(expectedType) || HelperFunctions.isReflexiveAncestorData(res, expectedType, actualType);
        }
    }
    ...
    public static List<String> getReturnTypesDataMethodNamed(Resource resource, List<IEObjectDescription> dMethods, final String runningClassName, List<String> argumentTypeNames) {
