...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Interrupt Statement</b></em>'. <!-- end-user-doc
 * -->
 *
 * <p>
...
public interface InterruptStatement extends Statement {
    ...
    /**
     * Sets the value of the '{@link org.eclipse.poosl.InterruptStatement#getNormalClause <em>Normal Clause</em>}'
    ...
    /**
     * Returns the value of the '<em><b>Interrupting Clause</b></em>' containment reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Interrupting Clause</em>' containment reference isn't clear, there really should be
    ...
    /**
     * Sets the value of the '{@link org.eclipse.poosl.InterruptStatement#getInterruptingClause <em>Interrupting
     * Clause</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Interrupting Clause</em>' containment reference.
