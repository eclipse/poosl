...
public interface Instance extends Annotable {
    ...
    /**
     * Sets the value of the '{@link org.eclipse.poosl.Instance#getName <em>Name</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @param value
    ...
    /**
     * Returns the value of the '<em><b>Instance Parameters</b></em>' containment reference list. The list contents are
     * of type {@link org.eclipse.poosl.InstanceParameter}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Instance Parameters</em>' containment reference list isn't clear, there really should
    ...
    /**
     * Returns the value of the '<em><b>Class Definition</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Class Definition</em>' attribute isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link org.eclipse.poosl.Instance#getClassDefinition <em>Class Definition</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Class Definition</em>' attribute.
