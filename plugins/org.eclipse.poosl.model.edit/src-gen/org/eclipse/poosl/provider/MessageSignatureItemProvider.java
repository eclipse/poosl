...
/**
 * This is the item provider adapter for a {@link org.eclipse.poosl.MessageSignature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageSignatureItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public MessageSignatureItemProvider(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageSignature_name_feature"), //$NON-NLS-1$
				 ...
				 PooslPackage.Literals.MESSAGE_SIGNATURE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addParametersPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageSignature_parameters_feature"), //$NON-NLS-1$
				 ...
				 PooslPackage.Literals.MESSAGE_SIGNATURE__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPortPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageSignature_port_feature"), //$NON-NLS-1$
				 ...
				 PooslPackage.Literals.MESSAGE_SIGNATURE__PORT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_MessageSignature_type") : //$NON-NLS-1$
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(MessageSignature.class))
		{
