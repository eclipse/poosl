...
/**
 * This is the item provider adapter for a {@link org.eclipse.poosl.ProcessMethodCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessMethodCallItemProvider extends StatementItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProcessMethodCall_outputVariables_feature"), //$NON-NLS-1$
	...
	protected void addMethodPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProcessMethodCall_method_feature"), //$NON-NLS-1$
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessMethodCall_type") : //$NON-NLS-1$
