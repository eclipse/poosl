...
/**
 * This is the item provider adapter for a {@link org.eclipse.poosl.ProcessClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessClassItemProvider extends InstantiableClassItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProcessClass_superClass_feature"), //$NON-NLS-1$
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessClass_type") : //$NON-NLS-1$
