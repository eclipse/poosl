...
public class BinaryOperatorExpressionItemProvider extends ExpressionItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryOperatorExpression_name_feature"), //$NON-NLS-1$
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BinaryOperatorExpression_type") : //$NON-NLS-1$
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
	{
		...
		boolean qualify =
			childFeature == PooslPackage.Literals.BINARY_OPERATOR_EXPRESSION__LEFT_OPERAND ||
			childFeature == PooslPackage.Literals.BINARY_OPERATOR_EXPRESSION__RIGHT_OPERAND;
