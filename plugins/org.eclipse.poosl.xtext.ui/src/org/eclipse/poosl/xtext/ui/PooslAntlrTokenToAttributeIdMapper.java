...
public class PooslAntlrTokenToAttributeIdMapper extends DefaultAntlrTokenToAttributeIdMapper {
    ...
    protected String calculateId(String tokenName, int tokenType) {
        ...
        if ("RULE_BINARY".equals(tokenName) || "RULE_OCTAL".equals(tokenName) || "RULE_HEXADECIMAL".equals(tokenName) || "RULE_DECIMAL_CORE".equals(tokenName) || "RULE_REAL_CORE".equals(tokenName)) {
