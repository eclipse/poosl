...
public class PooslReferenceFinder extends ReferenceFinder {
    ...
    protected void findLocalReferencesFromElement(
            Predicate<URI> targetURIs, EObject sourceCandidate, Resource localResource,
            Acceptor acceptor) {
    ...
    private void validateAndAccept(
        ...
        if (descr != null) {
            EObject instance = toValidInstanceOrNull(localResource, targetURIs,
                    descr.getEObjectOrProxy());
            if (instance != null) {
