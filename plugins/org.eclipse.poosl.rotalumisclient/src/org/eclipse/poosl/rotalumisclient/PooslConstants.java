...
public final class PooslConstants {
    // Debug model static
    public static final String DEBUG_MODEL_ID = "org.eclipse.poosl.rotalumisclient.DebugModelPresentation";

    public static final String PLUGIN_ID = "org.eclipse.poosl.rotalumisclient";
    ...
    // View ID statics
    public static final String ID_POOSL_SEQUENCEDIAGRAMVIEW = "org.eclipse.poosl.views.sequencediagramview";

    public static final String ID_POOSL_VARIABLESVIEW = "org.eclipse.poosl.views.variablesview";

    public static final String ID_POOSL_PETVIEW = "org.eclipse.poosl.views.petview";

    public static final String ID_POOSL_DEBUGVIEW = "org.eclipse.poosl.views.debugview";

    public static final String ID_POOSL_VARIABLESVIEW_DETAIL_PANE = "org.eclipse.poosl.rotalumisclient.PooslVariableDetailPane";

    public static final String ID_POOSL_STACKTRACEVIEW = "org.eclipse.poosl.views.stacktraceview";

    public static final String ID_POOSL_STACKTRACEVARIABLEVIEW = "org.eclipse.poosl.views.stacktracevariableview";

    // Perspective ID statics
    public static final String ID_POOSL_EDIT_PERSPECTIVE = "org.eclipse.poosl.normalperspective";

    public static final String ID_POOSL_DEBUG_PERSPECTIVE = "org.eclipse.poosl.debugperspective";
    ...
    public static final String CONFIGURATION_ATTRIBUTE_LAUNCH_TYPE = "org.eclipse.poosl.rotalumisclient.PooslLaunchConfiguration";

    public static final String CONFIGURATION_ATTRIBUTE_LAUNCH_TEST_TYPE = "org.eclipse.poosl.rotalumisclient.PooslTestLaunchConfiguration";
    ...
    // Command statics
    public static final String COMMAND_CLEAR_LAUNCHES = "org.eclipse.poosl.rotalumisclient.views.debug.clearlaunches";

    public static final String COMMAND_CLOSE_THREAD_WINDOWS = "org.eclipse.poosl.rotalumisclient.views.debug.closethreadwindows";

    public static final String COMMAND_STEPTYPE = "org.eclipse.poosl.rotalumisclient.stepcommand.steptype";
    ...
    public static final String COMMAND_DIAGRAM_VIEW = "org.eclipse.poosl.rotalumisclient.views.diagram.viewaction";
    ...
    public static final String COMMAND_DIAGRAM_SETUP = "org.eclipse.poosl.rotalumisclient.views.diagram.setupaction";
