...
public class PooslParser extends AbstractContentAssistParser {
    ...
    public static final class NameMappings {
        ...
        private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PooslGrammarAccess grammarAccess) {
            ...
            builder.put(grammarAccess.getIDStartWithinStatementExpressionLevel5Access().getArgumentsAssignment_1_3_1_1_1(),
            ...
            builder.put(grammarAccess.getNonIDStartWithinStatementExpressionLevel2Access().getRightOperandAssignment_1_2(),
            ...
            builder.put(grammarAccess.getNonIDStartWithinStatementExpressionLevel3Access().getRightOperandAssignment_1_2(),
            ...
            builder.put(grammarAccess.getNonIDStartWithinStatementExpressionLevel4Access().getRightOperandAssignment_1_2(),
                    "rule__NonIDStartWithinStatementExpressionLevel4__RightOperandAssignment_1_2");
            builder.put(grammarAccess.getNonIDStartWithinStatementExpressionLevel5Access().getOnSuperClassAssignment_1_1(),
            ...
            builder.put(grammarAccess.getNonIDStartWithinStatementExpressionLevel5Access().getArgumentsAssignment_1_3_1_0(),
                    "rule__NonIDStartWithinStatementExpressionLevel5__ArgumentsAssignment_1_3_1_0");
            builder.put(grammarAccess.getNonIDStartWithinStatementExpressionLevel5Access().getArgumentsAssignment_1_3_1_1_1(),
            ...
            builder.put(grammarAccess.getBracketedArgumentStartExpressionLevel2Access().getRightOperandAssignment_0_1_2(),
            ...
            builder.put(grammarAccess.getBracketedArgumentStartExpressionLevel2Access().getRightOperandAssignment_1_1_2(),
            ...
            builder.put(grammarAccess.getBracketedArgumentStartExpressionLevel3Access().getRightOperandAssignment_0_1_2(),
            ...
            builder.put(grammarAccess.getBracketedArgumentStartExpressionLevel3Access().getRightOperandAssignment_1_1_2(),
            ...
            builder.put(grammarAccess.getBracketedArgumentStartExpressionLevel4Access().getRightOperandAssignment_0_1_2(),
            ...
            builder.put(grammarAccess.getBracketedArgumentStartExpressionLevel4Access().getRightOperandAssignment_1_1_2(),
            ...
            builder.put(grammarAccess.getBracketedArgumentStartExpressionLevel5Access().getArgumentsAssignment_1_3_1_1_1(),
