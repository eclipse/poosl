	...
	implements ISelectionChangedListener
{
	...
	protected IAction showPropertiesViewAction =
		new Action(PooslEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) //$NON-NLS-1$
		{
			@Override
			public void run()
			{
	...
	protected IAction refreshViewerAction =
		new Action(PooslEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
		{
			@Override
