...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Operator Binary</b></em>', and
 * utility methods for working with them. <!-- end-user-doc -->
 * 
 * @see org.eclipse.poosl.PooslPackage#getOperatorBinary()
 * @model
 * @generated
 */
public enum OperatorBinary implements Enumerator {
    ...
    /**
     * An array of all the '<em><b>Operator Binary</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    private static final OperatorBinary[] VALUES_ARRAY = new OperatorBinary[] { ADD, SUBTRACT, MULTIPLY, DIVIDE, EQUAL, UNEQUAL, IDENTICAL, NOT_IDENTICAL, AND, OR, LESS_THAN, GREATER_THAN, AT_LEAST,
            AT_MOST, };

    /**
     * A public read-only list of all the '<em><b>Operator Binary</b></em>' enumerators. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * Returns the '<em><b>Operator Binary</b></em>' literal with the specified literal value. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @param literal
     *            the literal.
    ...
    /**
     * Returns the '<em><b>Operator Binary</b></em>' literal with the specified name. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @param name
     *            the name.
    ...
    /**
     * Returns the '<em><b>Operator Binary</b></em>' literal with the specified integer value. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @param value
     *            the integer value.
