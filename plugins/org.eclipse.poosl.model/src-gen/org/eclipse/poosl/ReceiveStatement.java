...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Receive Statement</b></em>'. <!-- end-user-doc
 * -->
 *
 * <p>
 ...
 * <li>{@link org.eclipse.poosl.ReceiveStatement#getPostCommunicationExpression <em>Post Communication
 * Expression</em>}</li>
 * </ul>
 *
...
public interface ReceiveStatement extends Statement {
    ...
    /**
     * Sets the value of the '{@link org.eclipse.poosl.ReceiveStatement#getPortDescriptor <em>Port Descriptor</em>}'
    ...
    /**
     * Sets the value of the '{@link org.eclipse.poosl.ReceiveStatement#getReceptionCondition <em>Reception
     * Condition</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Reception Condition</em>' containment reference.
    ...
    /**
     * Sets the value of the '{@link org.eclipse.poosl.ReceiveStatement#getPostCommunicationExpression <em>Post
