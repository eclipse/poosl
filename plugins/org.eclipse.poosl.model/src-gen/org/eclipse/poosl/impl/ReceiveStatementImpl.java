...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Receive Statement</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.poosl.impl.ReceiveStatementImpl#getPortDescriptor <em>Port Descriptor</em>}</li>
 * <li>{@link org.eclipse.poosl.impl.ReceiveStatementImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.poosl.impl.ReceiveStatementImpl#getVariables <em>Variables</em>}</li>
 * <li>{@link org.eclipse.poosl.impl.ReceiveStatementImpl#getReceptionCondition <em>Reception Condition</em>}</li>
 * <li>{@link org.eclipse.poosl.impl.ReceiveStatementImpl#getPostCommunicationExpression <em>Post Communication
 * Expression</em>}</li>
 * </ul>
 *
 * @generated
...
public class ReceiveStatementImpl extends StatementImpl implements ReceiveStatement {
    ...
    /**
     * The cached value of the '{@link #getPostCommunicationExpression() <em>Post Communication Expression</em>}'
    ...
    public NotificationChain basicSetPostCommunicationExpression(Expression newPostCommunicationExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PooslPackage.RECEIVE_STATEMENT__POST_COMMUNICATION_EXPRESSION, oldPostCommunicationExpression,
                    newPostCommunicationExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
