...
public class PooslGrammarAccess extends AbstractGrammarElementFinder {
    ...
    public class PooslElements extends AbstractParserRuleElementFinder {
        ...
        // (clusterClasses+=System (dataClasses+=DataClass | processClasses+=ProcessClass |
        // clusterClasses+=ClusterClass)*)?
    ...
    public class DataClassElements extends AbstractParserRuleElementFinder {
        ...
        // annotations+=Annotation* native?='native'? 'data' 'class' name=IDENTIFIER ('extends' superClass=IDENTIFIER)?
        // 'variables'
    ...
    public class ProcessMethodElements extends AbstractParserRuleElementFinder {
        ...
        // annotations+=Annotation* name=IDENTIFIER '(' (inputParameters+=Declaration (','
    ...
    public class MessageReceiveSignatureElements extends AbstractParserRuleElementFinder {
        ...
        // port=PortReference '?' name=IDENTIFIER ('(' (parameters+=MessageParameter (','
    ...
    public class SystemElements extends AbstractParserRuleElementFinder {
        ...
        // {ClusterClass} annotations+=Annotation* 'system' ('(' (parameters+=Declaration (','
        // parameters+=Declaration)*)? ')')?
        // ('ports' (ports+=Port (','? ports+=Port)* ','?)?)? 'instances' instances+=Instance* 'channels'
        // channels+=Channel*
        public Group getGroup() {
            return cGroup;
        }
    ...
    public class ClusterClassElements extends AbstractParserRuleElementFinder {
        ...
        // parameters+=Declaration)*)? ')')? 'ports' (ports+=Port (','? ports+=Port)* ','?)? 'instances'
        // instances+=Instance*
        // 'channels' channels+=Channel*
        public Group getGroup() {
            return cGroup;
    ...
    public class InstanceElements extends AbstractParserRuleElementFinder {
        ...
        // annotations+=Annotation* name=IDENTIFIER ':' classDefinition=IDENTIFIER ('('
        // (instanceParameters+=InstanceParameter (','
        // instanceParameters+=InstanceParameter)*)? ')')?
        public Group getGroup() {
            return cGroup;
    ...
    public class ExpressionLevel1Elements extends AbstractParserRuleElementFinder {
        ...
        // ExpressionLevel2 | {AssignmentExpression} variable=IDENTIFIER ':=' expression=ExpressionLevel1 |
        // {ReturnExpression}
    ...
    public class SwitchExpressionElements extends AbstractParserRuleElementFinder {
        ...
        // 'switch' expression=Expression 'do' (cases+=SwitchExpressionCase+ ('default' defaultBody=Expression)? |
        // 'default'
    ...
    public class ExpressionConstantElements extends AbstractParserRuleElementFinder {
        ...
        // BooleanConstant | CharacterConstant | FloatConstant | IntegerConstant | NilConstant | RealConstant |
        // StringConstant |
        // EnvironmentConstant;
        @Override
        public ParserRule getRule() {
    ...
    public class IDStartWithinStatementExpressionLevel1Elements extends AbstractParserRuleElementFinder {
        ...
        // IDStartWithinStatementExpressionLevel2 | {AssignmentExpression} variable=IDENTIFIER ':='
        // expression=ExpressionLevel1
        public Alternatives getAlternatives() {
            return cAlternatives;
        }
    ...
    public class IDStartWithinStatementExpressionLevel2Elements extends AbstractParserRuleElementFinder {
        ...
        // IDStartWithinStatementExpressionLevel3 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel2
        // rightOperand=ExpressionLevel3)*;
        @Override
        public ParserRule getRule() {
    ...
    public class IDStartWithinStatementExpressionLevel3Elements extends AbstractParserRuleElementFinder {
        ...
        // IDStartWithinStatementExpressionLevel4 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel3
        // rightOperand=ExpressionLevel4)*;
        @Override
        public ParserRule getRule() {
    ...
    public class IDStartWithinStatementExpressionLevel4Elements extends AbstractParserRuleElementFinder {
        ...
        // IDStartWithinStatementExpressionLevel5 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel4
        // rightOperand=ExpressionLevel5)*;
        @Override
        public ParserRule getRule() {
    ...
    public class NonIDStartWithinStatementExpressionLevel2Elements extends AbstractParserRuleElementFinder {
        ...
        // NonIDStartWithinStatementExpressionLevel3 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel2
        // rightOperand=ExpressionLevel3)*;
        @Override
        public ParserRule getRule() {
    ...
    public class NonIDStartWithinStatementExpressionLevel3Elements extends AbstractParserRuleElementFinder {
        ...
        // NonIDStartWithinStatementExpressionLevel4 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel3
        // rightOperand=ExpressionLevel4)*;
        @Override
        public ParserRule getRule() {
    ...
    public class NonIDStartWithinStatementExpressionLevel4Elements extends AbstractParserRuleElementFinder {
        ...
        // NonIDStartWithinStatementExpressionLevel5 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel4
        // rightOperand=ExpressionLevel5)*;
        @Override
        public ParserRule getRule() {
    ...
    public class ReceiveStatementElements extends AbstractParserRuleElementFinder {
        ...
        // ReceiveStatement:
        // portDescriptor=PortDescriptor '?' name=IDENTIFIER ('(' (variables+=OutputVariable (','
    ...
    public class SwitchStatementElements extends AbstractParserRuleElementFinder {
        ...
        // 'switch' expression=Expression 'do' (cases+=SwitchStatementCase+ ('default' defaultBody=Statement)? |
        // 'default'
    ...
    public class BracketedArgumentStartExpressionLevel2Elements extends AbstractParserRuleElementFinder {
        ...
        // =>
        // BracketedArgumentStartExpressionLevel3 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel2
        // rightOperand=ExpressionLevel3)*
        ...
        // => BracketedArgumentStartExpressionLevel3 ({BinaryOperatorExpression.leftOperand=current}
        //// name=BinaryOperatorLevel2
        // rightOperand=ExpressionLevel3)* | ExpressionSequenceRoundBracket
        //// ({BinaryOperatorExpression.leftOperand=current}
    ...
    public class BracketedArgumentStartExpressionLevel3Elements extends AbstractParserRuleElementFinder {
        ...
        // =>
        // BracketedArgumentStartExpressionLevel4 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel3
        // rightOperand=ExpressionLevel4)*
        ...
        // => BracketedArgumentStartExpressionLevel4 ({BinaryOperatorExpression.leftOperand=current}
        //// name=BinaryOperatorLevel3
        // rightOperand=ExpressionLevel4)* | ExpressionSequenceRoundBracket
        //// ({BinaryOperatorExpression.leftOperand=current}
    ...
    public class BracketedArgumentStartExpressionLevel4Elements extends AbstractParserRuleElementFinder {
        ...
        // =>
        // BracketedArgumentStartExpressionLevel5 ({BinaryOperatorExpression.leftOperand=current}
        // name=BinaryOperatorLevel4
        // rightOperand=ExpressionLevel5)*
        ...
        // => BracketedArgumentStartExpressionLevel5 ({BinaryOperatorExpression.leftOperand=current}
        //// name=BinaryOperatorLevel4
        // rightOperand=ExpressionLevel5)* | ExpressionSequenceRoundBracket
        //// ({BinaryOperatorExpression.leftOperand=current}
    ...
    // '\\x' '0' ('1'..'9' | 'a'..'f' | 'A'..'F') | '\\x' ('1'..'9' | 'a'..'f' | 'A'..'F') ('0'..'9' | 'a'..'f' |
    // 'A'..'F')?
    // | '\\n' | '\\t' | '\\v' | '\\b' | '\\r' | '\\f' | '\\a' | '\\\\' | '\\?' | '\\\'' | '\\\"';
