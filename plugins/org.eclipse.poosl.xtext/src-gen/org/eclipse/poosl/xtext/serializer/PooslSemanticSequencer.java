...
public class PooslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
    ...
    public void sequence(ISerializationContext context, EObject semanticObject) {
        ...
        if (epackage == PooslPackage.eINSTANCE)
            ...
            case PooslPackage.ASSIGNMENT_EXPRESSION:
                if (rule == grammarAccess.getExpressionRule() || action == grammarAccess.getExpressionAccess().getExpressionSequenceExpressionsAction_1_0()
                        || rule == grammarAccess.getExpressionSingleRule() || rule == grammarAccess.getExpressionLevel1Rule()) {
                    sequence_ExpressionLevel1(context, (AssignmentExpression) semanticObject);
                    return;
                } else if (rule == grammarAccess.getIDStartWithinStatementExpressionSingleRule() || rule == grammarAccess.getIDStartWithinStatementExpressionLevel1Rule()) {
            ...
            case PooslPackage.BINARY_OPERATOR_EXPRESSION:
                if (action == grammarAccess.getBracketedArgumentStartExpressionLevel2Access().getBinaryOperatorExpressionLeftOperandAction_1_1_0()) {
                    ...
                    return;
                } else if (rule == grammarAccess.getBracketedArgumentStartExpressionSingleRule() || rule == grammarAccess.getBracketedArgumentStartExpressionLevel1Rule()
                    ...
                    sequence_BracketedArgumentStartExpressionLevel2_BracketedArgumentStartExpressionLevel3_BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_0_1_0(context,
                            (BinaryOperatorExpression) semanticObject);
                    return;
                    ...
                    return;
                } else if (rule == grammarAccess.getExpressionRule() || action == grammarAccess.getExpressionAccess().getExpressionSequenceExpressionsAction_1_0()
                        || rule == grammarAccess.getExpressionSingleRule() || rule == grammarAccess.getExpressionLevel1Rule() || rule == grammarAccess.getExpressionLevel2Rule()
                    ...
                    return;
                } else if (rule == grammarAccess.getExpressionLevel3Rule() || action == grammarAccess.getExpressionLevel3Access().getBinaryOperatorExpressionLeftOperandAction_1_0()) {
                    sequence_ExpressionLevel3_ExpressionLevel4(context, (BinaryOperatorExpression) semanticObject);
                    return;
                } else if (rule == grammarAccess.getExpressionLevel4Rule() || action == grammarAccess.getExpressionLevel4Access().getBinaryOperatorExpressionLeftOperandAction_1_0()) {
                    ...
                    return;
                } else if (rule == grammarAccess.getNonIDStartWithinStatementExpressionSingleRule() || rule == grammarAccess.getNonIDStartWithinStatementExpressionLevel1Rule()
                    ...
                    sequence_NonIDStartWithinStatementExpressionLevel2_NonIDStartWithinStatementExpressionLevel3_NonIDStartWithinStatementExpressionLevel4(context,
                            (BinaryOperatorExpression) semanticObject);
                    return;
            ...
            case PooslPackage.DATA_METHOD_CALL_EXPRESSION:
                if (rule == grammarAccess.getBracketedArgumentStartExpressionSingleRule() || rule == grammarAccess.getBracketedArgumentStartExpressionLevel1Rule()
                        || rule == grammarAccess.getBracketedArgumentStartExpressionLevel2Rule()
                    ...
                    return;
                        ...
                        || rule == grammarAccess.getExpressionSingleRule() || rule == grammarAccess.getExpressionLevel1Rule() || rule == grammarAccess.getExpressionLevel2Rule()
                        || action == grammarAccess.getExpressionLevel2Access().getBinaryOperatorExpressionLeftOperandAction_1_0() || rule == grammarAccess.getExpressionLevel3Rule()
                        || action == grammarAccess.getExpressionLevel3Access().getBinaryOperatorExpressionLeftOperandAction_1_0() || rule == grammarAccess.getExpressionLevel4Rule()
                        || action == grammarAccess.getExpressionLevel4Access().getBinaryOperatorExpressionLeftOperandAction_1_0() || rule == grammarAccess.getExpressionLevel5Rule()
            ...
            case PooslPackage.EXPRESSION_STATEMENT:
                if (rule == grammarAccess.getBracketStartStatementRule() || rule == grammarAccess.getBracketedArgumentStartExpressionStatementRule()) {
                    sequence_BracketedArgumentStartExpressionStatement(context, (ExpressionStatement) semanticObject);
                    return;
                } else if (rule == grammarAccess.getStatementRule() || action == grammarAccess.getStatementAccess().getStatementSequenceStatementsAction_1_0()
    ...
    /**
     * Contexts: Statement returns AbortStatement Statement.StatementSequence_1_0 returns AbortStatement StatementSingle
     * returns AbortStatement AbortStatement returns AbortStatement
     *
     * Constraint: (normalClause=Statement abortingClause=StatementSingle)
     */
    ...
    /**
     * Contexts: Annotation returns Annotation
     *
     * Constraint: (name=IDENTIFIER (arguments+=ExpressionConstant arguments+=ExpressionConstant*)?)
     */
    ...
    /**
     * Contexts: Expression returns BooleanConstant Expression.ExpressionSequence_1_0 returns BooleanConstant
     * ExpressionSingle returns BooleanConstant ExpressionLevel1 returns BooleanConstant ExpressionLevel2 returns
     * BooleanConstant ExpressionLevel2.BinaryOperatorExpression_1_0 returns BooleanConstant ExpressionLevel3 returns
     * BooleanConstant ExpressionLevel3.BinaryOperatorExpression_1_0 returns BooleanConstant ExpressionLevel4 returns
     * BooleanConstant ExpressionLevel4.BinaryOperatorExpression_1_0 returns BooleanConstant ExpressionLevel5 returns
     * BooleanConstant ExpressionLevel5.DataMethodCallExpression_1_0 returns BooleanConstant ExpressionLevel6 returns
     * BooleanConstant ExpressionLevel7 returns BooleanConstant ExpressionConstant returns BooleanConstant
     * BooleanConstant returns BooleanConstant NonIDStartWithinStatementExpressionSingle returns BooleanConstant
     * NonIDStartWithinStatementExpressionLevel1 returns BooleanConstant NonIDStartWithinStatementExpressionLevel2
     * returns BooleanConstant NonIDStartWithinStatementExpressionLevel2.BinaryOperatorExpression_1_0 returns
     * BooleanConstant NonIDStartWithinStatementExpressionLevel3 returns BooleanConstant
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns BooleanConstant NonIDStartWithinStatementExpressionLevel7
    ...
    /**
     * Contexts: BracketedArgumentStartExpressionLevel2.BinaryOperatorExpression_1_1_0 returns BinaryOperatorExpression
     *
     * Constraint: (leftOperand=BracketedArgumentStartExpressionLevel2_BinaryOperatorExpression_1_1_0
    ...
    /**
     * Contexts: BracketedArgumentStartExpressionSingle returns BinaryOperatorExpression
     * BracketedArgumentStartExpressionLevel1 returns BinaryOperatorExpression BracketedArgumentStartExpressionLevel2
     * returns BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=BracketedArgumentStartExpressionLevel2_BinaryOperatorExpression_0_1_0
     * name=BinaryOperatorLevel2 rightOperand=ExpressionLevel3) |
     * (leftOperand=BracketedArgumentStartExpressionLevel2_BinaryOperatorExpression_1_1_0 name=BinaryOperatorLevel2
     * rightOperand=ExpressionLevel3) |
     * (leftOperand=BracketedArgumentStartExpressionLevel3_BinaryOperatorExpression_0_1_0 name=BinaryOperatorLevel3
     * rightOperand=ExpressionLevel4) |
     * (leftOperand=BracketedArgumentStartExpressionLevel3_BinaryOperatorExpression_1_1_0 name=BinaryOperatorLevel3
     * rightOperand=ExpressionLevel4) |
     * (leftOperand=BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_0_1_0 name=BinaryOperatorLevel4
     * rightOperand=ExpressionLevel5) |
     * (leftOperand=BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_1_1_0 name=BinaryOperatorLevel4
     * rightOperand=ExpressionLevel5) )
     */
    protected void sequence_BracketedArgumentStartExpressionLevel2_BracketedArgumentStartExpressionLevel3_BracketedArgumentStartExpressionLevel4(ISerializationContext context,
            BinaryOperatorExpression semanticObject) {
        genericSequencer.createSequence(context, semanticObject);
    }

    /**
     * Contexts: BracketedArgumentStartExpressionLevel2.BinaryOperatorExpression_0_1_0 returns BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=BracketedArgumentStartExpressionLevel2_BinaryOperatorExpression_0_1_0
     * name=BinaryOperatorLevel2 rightOperand=ExpressionLevel3) |
     * (leftOperand=BracketedArgumentStartExpressionLevel3_BinaryOperatorExpression_0_1_0 name=BinaryOperatorLevel3
     ...
     * rightOperand=ExpressionLevel5) )
     */
    protected void sequence_BracketedArgumentStartExpressionLevel2_BracketedArgumentStartExpressionLevel3_BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_0_1_0(
            ISerializationContext context, BinaryOperatorExpression semanticObject) {
        genericSequencer.createSequence(context, semanticObject);
    }

    /**
     * Contexts: BracketedArgumentStartExpressionLevel3.BinaryOperatorExpression_1_1_0 returns BinaryOperatorExpression
     *
     * Constraint: (leftOperand=BracketedArgumentStartExpressionLevel3_BinaryOperatorExpression_1_1_0
    ...
    /**
     * Contexts: BracketedArgumentStartExpressionLevel3 returns BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=BracketedArgumentStartExpressionLevel3_BinaryOperatorExpression_0_1_0
     * name=BinaryOperatorLevel3 rightOperand=ExpressionLevel4) |
     * (leftOperand=BracketedArgumentStartExpressionLevel3_BinaryOperatorExpression_1_1_0 name=BinaryOperatorLevel3
     * rightOperand=ExpressionLevel4) |
     * (leftOperand=BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_0_1_0 name=BinaryOperatorLevel4
    ...
    /**
     * Contexts: BracketedArgumentStartExpressionLevel3.BinaryOperatorExpression_0_1_0 returns BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=BracketedArgumentStartExpressionLevel3_BinaryOperatorExpression_0_1_0
     * name=BinaryOperatorLevel3 rightOperand=ExpressionLevel4) |
     * (leftOperand=BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_0_1_0 name=BinaryOperatorLevel4
     ...
     * rightOperand=ExpressionLevel5) )
     */
    protected void sequence_BracketedArgumentStartExpressionLevel3_BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_0_1_0(ISerializationContext context,
            BinaryOperatorExpression semanticObject) {
        genericSequencer.createSequence(context, semanticObject);
    }

    /**
     * Contexts: BracketedArgumentStartExpressionLevel4 returns BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_0_1_0
    ...
    /**
     * Contexts: BracketedArgumentStartExpressionLevel4.BinaryOperatorExpression_0_1_0 returns BinaryOperatorExpression
     *
     * Constraint: (leftOperand=BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_0_1_0
     * name=BinaryOperatorLevel4 rightOperand=ExpressionLevel5)
     */
    ...
    /**
     * Contexts: BracketedArgumentStartExpressionLevel4.BinaryOperatorExpression_1_1_0 returns BinaryOperatorExpression
     *
     * Constraint: (leftOperand=BracketedArgumentStartExpressionLevel4_BinaryOperatorExpression_1_1_0
     * name=BinaryOperatorLevel4 rightOperand=ExpressionLevel5)
     */
    ...
    /**
     * Contexts: BracketedArgumentStartExpressionSingle returns DataMethodCallExpression
     * BracketedArgumentStartExpressionLevel1 returns DataMethodCallExpression BracketedArgumentStartExpressionLevel2
     * returns DataMethodCallExpression BracketedArgumentStartExpressionLevel2.BinaryOperatorExpression_0_1_0 returns
     * DataMethodCallExpression BracketedArgumentStartExpressionLevel3 returns DataMethodCallExpression
     ...
     *
     * Constraint: ( target=BracketedArgumentStartExpressionLevel5_DataMethodCallExpression_1_0 onSuperClass?='^'?
    ...
    /**
     * Contexts: BracketStartStatement returns ExpressionStatement BracketedArgumentStartExpressionStatement returns
     * ExpressionStatement
     *
     * Constraint: expression=BracketedArgumentStartExpressionSingle
     */
    ...
    /**
     * Contexts: Statement returns ExpressionStatement Statement.StatementSequence_1_0 returns ExpressionStatement
     * StatementSingle returns ExpressionStatement
     *
     * Constraint: ( expression=IDStartWithinStatementExpressionSingle |
     * expression=NonIDStartWithinStatementExpressionSingle | expression=Expression |
    ...
    /**
     * Contexts: Channel returns Channel
     *
     * Constraint: ( annotations+=Annotation* ( (instancePorts+=InstancePort instancePorts+=InstancePort*
    ...
    /**
     * Contexts: Expression returns CharacterConstant Expression.ExpressionSequence_1_0 returns CharacterConstant
     * ExpressionSingle returns CharacterConstant ExpressionLevel1 returns CharacterConstant ExpressionLevel2 returns
     * CharacterConstant ExpressionLevel2.BinaryOperatorExpression_1_0 returns CharacterConstant ExpressionLevel3
     * returns CharacterConstant ExpressionLevel3.BinaryOperatorExpression_1_0 returns CharacterConstant
     * ExpressionLevel4 returns CharacterConstant ExpressionLevel4.BinaryOperatorExpression_1_0 returns
     * CharacterConstant ExpressionLevel5 returns CharacterConstant ExpressionLevel5.DataMethodCallExpression_1_0
     * returns CharacterConstant ExpressionLevel6 returns CharacterConstant ExpressionLevel7 returns CharacterConstant
     * ExpressionConstant returns CharacterConstant CharacterConstant returns CharacterConstant
     * NonIDStartWithinStatementExpressionSingle returns CharacterConstant NonIDStartWithinStatementExpressionLevel1
     * returns CharacterConstant NonIDStartWithinStatementExpressionLevel2 returns CharacterConstant
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns CharacterConstant NonIDStartWithinStatementExpressionLevel7
     * returns CharacterConstant
     *
    ...
    /**
     * Contexts: ClusterClass returns ClusterClass
     *
     * Constraint: ( annotations+=Annotation* name=IDENTIFIER (parameters+=Declaration parameters+=Declaration*)?
     * (ports+=Port ports+=Port*)? instances+=Instance* channels+=Channel* )
     */
    ...
    /**
     * Contexts: Expression returns CurrentTimeExpression Expression.ExpressionSequence_1_0 returns
     * CurrentTimeExpression ExpressionSingle returns CurrentTimeExpression ExpressionLevel1 returns
     * CurrentTimeExpression ExpressionLevel2 returns CurrentTimeExpression
     * ExpressionLevel2.BinaryOperatorExpression_1_0 returns CurrentTimeExpression ExpressionLevel3 returns
     * CurrentTimeExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns CurrentTimeExpression
     * ExpressionLevel4 returns CurrentTimeExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns
     * CurrentTimeExpression ExpressionLevel5 returns CurrentTimeExpression
     * ExpressionLevel5.DataMethodCallExpression_1_0 returns CurrentTimeExpression ExpressionLevel6 returns
     * CurrentTimeExpression ExpressionLevel7 returns CurrentTimeExpression CurrentTimeExpression returns
     * CurrentTimeExpression NonIDStartWithinStatementExpressionSingle returns CurrentTimeExpression
     * NonIDStartWithinStatementExpressionLevel1 returns CurrentTimeExpression NonIDStartWithinStatementExpressionLevel2
     * returns CurrentTimeExpression NonIDStartWithinStatementExpressionLevel2.BinaryOperatorExpression_1_0 returns
     * CurrentTimeExpression NonIDStartWithinStatementExpressionLevel3 returns CurrentTimeExpression
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns CurrentTimeExpression NonIDStartWithinStatementExpressionLevel7
     * returns CurrentTimeExpression
     *
     * Constraint: {CurrentTimeExpression}
     */
    ...
    /**
     * Contexts: DataClass returns DataClass
     *
     * Constraint: ( annotations+=Annotation* native?='native'? name=IDENTIFIER superClass=IDENTIFIER?
     * (instanceVariables+=Declaration instanceVariables+=Declaration*)? (dataMethodsNamed+=DataMethodNamed |
     * dataMethodsUnaryOperator+=DataMethodUnaryOperator | dataMethodsBinaryOperator+=DataMethodBinaryOperator)* )
     */
    ...
    /**
     * Contexts: DataMethodBinaryOperator returns DataMethodBinaryOperator
     *
     * Constraint: ( annotations+=Annotation* native?='native'? name=OperatorBinary parameters+=Declaration
     * parameters+=Declaration* returnType=IDENTIFIER (localVariables+=Declaration localVariables+=Declaration*)?
     * body=Expression? )
     */
    ...
    /**
     * Contexts: DataMethodNamed returns DataMethodNamed
     *
     * Constraint: ( annotations+=Annotation* native?='native'? name=IDENTIFIER (parameters+=Declaration
     * parameters+=Declaration*)? returnType=IDENTIFIER (localVariables+=Declaration localVariables+=Declaration*)?
     * body=Expression? )
     */
    ...
    /**
     * Contexts: DataMethodUnaryOperator returns DataMethodUnaryOperator
     *
     * Constraint: ( annotations+=Annotation* native?='native'? name=OperatorUnary returnType=IDENTIFIER
    ...
    /**
     * Contexts: Declaration returns Declaration
     *
     * Constraint: ((variables+=Variable variables+=Variable*)? type=IDENTIFIER)
     */
    ...
    /**
     * Contexts: Statement returns DelayStatement Statement.StatementSequence_1_0 returns DelayStatement StatementSingle
     * returns DelayStatement DelayStatement returns DelayStatement
     *
     * Constraint: expression=ExpressionSingle
     */
    ...
    /**
     * Contexts: Expression returns EnvironmentConstant Expression.ExpressionSequence_1_0 returns EnvironmentConstant
     * ExpressionSingle returns EnvironmentConstant ExpressionLevel1 returns EnvironmentConstant ExpressionLevel2
     * returns EnvironmentConstant ExpressionLevel2.BinaryOperatorExpression_1_0 returns EnvironmentConstant
     * ExpressionLevel3 returns EnvironmentConstant ExpressionLevel3.BinaryOperatorExpression_1_0 returns
     * EnvironmentConstant ExpressionLevel4 returns EnvironmentConstant ExpressionLevel4.BinaryOperatorExpression_1_0
     * returns EnvironmentConstant ExpressionLevel5 returns EnvironmentConstant
     * ExpressionLevel5.DataMethodCallExpression_1_0 returns EnvironmentConstant ExpressionLevel6 returns
     * EnvironmentConstant ExpressionLevel7 returns EnvironmentConstant ExpressionConstant returns EnvironmentConstant
     * EnvironmentConstant returns EnvironmentConstant NonIDStartWithinStatementExpressionSingle returns
     * EnvironmentConstant NonIDStartWithinStatementExpressionLevel1 returns EnvironmentConstant
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns EnvironmentConstant NonIDStartWithinStatementExpressionLevel7
     * returns EnvironmentConstant
     *
     * Constraint: value=ENVIRONMENT_VARIABLE_NAME
     */
    ...
    /**
     * Contexts: Expression returns AssignmentExpression Expression.ExpressionSequence_1_0 returns AssignmentExpression
     * ExpressionSingle returns AssignmentExpression ExpressionLevel1 returns AssignmentExpression
     *
     * Constraint: (variable=IDENTIFIER expression=ExpressionLevel1)
     */
    ...
    /**
     * Contexts: Expression returns ReturnExpression Expression.ExpressionSequence_1_0 returns ReturnExpression
     * ExpressionSingle returns ReturnExpression ExpressionLevel1 returns ReturnExpression
     *
     * Constraint: expression=ExpressionLevel1
     */
    ...
    /**
     * Contexts: Expression returns BinaryOperatorExpression Expression.ExpressionSequence_1_0 returns
     * BinaryOperatorExpression ExpressionSingle returns BinaryOperatorExpression ExpressionLevel1 returns
     * BinaryOperatorExpression ExpressionLevel2 returns BinaryOperatorExpression
     * ExpressionLevel2.BinaryOperatorExpression_1_0 returns BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=ExpressionLevel2_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel2
     * rightOperand=ExpressionLevel3) | (leftOperand=ExpressionLevel3_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel3 rightOperand=ExpressionLevel4) |
     * (leftOperand=ExpressionLevel4_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel4
     * rightOperand=ExpressionLevel5) )
     */
    ...
    /**
     * Contexts: ExpressionLevel3 returns BinaryOperatorExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns
     * BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=ExpressionLevel3_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel3
     * rightOperand=ExpressionLevel4) | (leftOperand=ExpressionLevel4_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel4 rightOperand=ExpressionLevel5) )
     */
    ...
    /**
     * Contexts: ExpressionLevel4 returns BinaryOperatorExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns
     * BinaryOperatorExpression
     *
     * Constraint: (leftOperand=ExpressionLevel4_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel4
     * rightOperand=ExpressionLevel5)
     */
    ...
    /**
     * Contexts: Expression returns DataMethodCallExpression Expression.ExpressionSequence_1_0 returns
     * DataMethodCallExpression ExpressionSingle returns DataMethodCallExpression ExpressionLevel1 returns
     * DataMethodCallExpression ExpressionLevel2 returns DataMethodCallExpression
     * ExpressionLevel2.BinaryOperatorExpression_1_0 returns DataMethodCallExpression ExpressionLevel3 returns
     * DataMethodCallExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns DataMethodCallExpression
     * ExpressionLevel4 returns DataMethodCallExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns
     * DataMethodCallExpression ExpressionLevel5 returns DataMethodCallExpression
     * ExpressionLevel5.DataMethodCallExpression_1_0 returns DataMethodCallExpression
     *
     * Constraint: (target=ExpressionLevel5_DataMethodCallExpression_1_0 onSuperClass?='^'? name=IDENTIFIER
    ...
    /**
     * Contexts: Expression returns ExpressionSequenceRoundBracket Expression.ExpressionSequence_1_0 returns
     * ExpressionSequenceRoundBracket ExpressionSingle returns ExpressionSequenceRoundBracket ExpressionLevel1 returns
     * ExpressionSequenceRoundBracket ExpressionLevel2 returns ExpressionSequenceRoundBracket
     * ExpressionLevel2.BinaryOperatorExpression_1_0 returns ExpressionSequenceRoundBracket ExpressionLevel3 returns
     * ExpressionSequenceRoundBracket ExpressionLevel3.BinaryOperatorExpression_1_0 returns
     * ExpressionSequenceRoundBracket ExpressionLevel4 returns ExpressionSequenceRoundBracket
     * ExpressionLevel4.BinaryOperatorExpression_1_0 returns ExpressionSequenceRoundBracket ExpressionLevel5 returns
     * ExpressionSequenceRoundBracket ExpressionLevel5.DataMethodCallExpression_1_0 returns
     * ExpressionSequenceRoundBracket ExpressionLevel6 returns ExpressionSequenceRoundBracket ExpressionLevel7 returns
     * ExpressionSequenceRoundBracket ExpressionSequenceRoundBracket returns ExpressionSequenceRoundBracket
     ...
     *
     * Constraint: (expressions+=ExpressionSingle expressions+=ExpressionSingle*)
     */
    ...
    /**
     * Contexts: ExpressionStatement returns ExpressionStatement
     *
     * Constraint: (expression=IDStartWithinStatementExpressionSingle |
     * expression=NonIDStartWithinStatementExpressionSingle | expression=Expression)
     */
    ...
    /**
     * Contexts: Expression returns ExpressionSequence
     *
     * Constraint: (expressions+=Expression_ExpressionSequence_1_0 expressions+=ExpressionSingle+)
     */
    ...
    /**
     * Contexts: Expression returns FloatConstant Expression.ExpressionSequence_1_0 returns FloatConstant
     * ExpressionSingle returns FloatConstant ExpressionLevel1 returns FloatConstant ExpressionLevel2 returns
     * FloatConstant ExpressionLevel2.BinaryOperatorExpression_1_0 returns FloatConstant ExpressionLevel3 returns
     * FloatConstant ExpressionLevel3.BinaryOperatorExpression_1_0 returns FloatConstant ExpressionLevel4 returns
     * FloatConstant ExpressionLevel4.BinaryOperatorExpression_1_0 returns FloatConstant ExpressionLevel5 returns
     * FloatConstant ExpressionLevel5.DataMethodCallExpression_1_0 returns FloatConstant ExpressionLevel6 returns
     * FloatConstant ExpressionLevel7 returns FloatConstant ExpressionConstant returns FloatConstant FloatConstant
     * returns FloatConstant NonIDStartWithinStatementExpressionSingle returns FloatConstant
     * NonIDStartWithinStatementExpressionLevel1 returns FloatConstant NonIDStartWithinStatementExpressionLevel2 returns
     * FloatConstant NonIDStartWithinStatementExpressionLevel2.BinaryOperatorExpression_1_0 returns FloatConstant
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns FloatConstant NonIDStartWithinStatementExpressionLevel7 returns
     * FloatConstant
     *
    ...
    /**
     * Contexts: Statement returns GuardedStatement Statement.StatementSequence_1_0 returns GuardedStatement
     * StatementSingle returns GuardedStatement GuardedStatement returns GuardedStatement
     *
     * Constraint: (guard=Expression statement=StatementSingle)
     */
    ...
    /**
     * Contexts: IDStartWithinStatementExpressionSingle returns AssignmentExpression
    ...
    /**
     * Contexts: IDStartWithinStatementExpressionSingle returns BinaryOperatorExpression
     * IDStartWithinStatementExpressionLevel1 returns BinaryOperatorExpression IDStartWithinStatementExpressionLevel2
     * returns BinaryOperatorExpression IDStartWithinStatementExpressionLevel2.BinaryOperatorExpression_1_0 returns
     * BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=IDStartWithinStatementExpressionLevel2_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel2 rightOperand=ExpressionLevel3) |
     * (leftOperand=IDStartWithinStatementExpressionLevel3_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel3
     * rightOperand=ExpressionLevel4) | (leftOperand=IDStartWithinStatementExpressionLevel4_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel4 rightOperand=ExpressionLevel5) )
     */
    protected void sequence_IDStartWithinStatementExpressionLevel2_IDStartWithinStatementExpressionLevel3_IDStartWithinStatementExpressionLevel4(ISerializationContext context,
            BinaryOperatorExpression semanticObject) {
        genericSequencer.createSequence(context, semanticObject);
    }

    /**
     * Contexts: IDStartWithinStatementExpressionLevel3 returns BinaryOperatorExpression
     * IDStartWithinStatementExpressionLevel3.BinaryOperatorExpression_1_0 returns BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=IDStartWithinStatementExpressionLevel3_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel3 rightOperand=ExpressionLevel4) |
     * (leftOperand=IDStartWithinStatementExpressionLevel4_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel4
     * rightOperand=ExpressionLevel5) )
     */
    ...
    /**
     * Contexts: IDStartWithinStatementExpressionLevel4 returns BinaryOperatorExpression
     * IDStartWithinStatementExpressionLevel4.BinaryOperatorExpression_1_0 returns BinaryOperatorExpression
     *
     * Constraint: (leftOperand=IDStartWithinStatementExpressionLevel4_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel4 rightOperand=ExpressionLevel5)
     */
    ...
    /**
     * Contexts: IDStartWithinStatementExpressionSingle returns DataMethodCallExpression
     * IDStartWithinStatementExpressionLevel1 returns DataMethodCallExpression IDStartWithinStatementExpressionLevel2
     * returns DataMethodCallExpression IDStartWithinStatementExpressionLevel2.BinaryOperatorExpression_1_0 returns
     * DataMethodCallExpression IDStartWithinStatementExpressionLevel3 returns DataMethodCallExpression
     ...
     *
     * Constraint: ( target=IDStartWithinStatementExpressionLevel5_DataMethodCallExpression_1_0 onSuperClass?='^'?
     * name=IDENTIFIER (arguments+=Expression arguments+=Expression*)? )
     */
    ...
    /**
     * Contexts: Expression returns IfExpression Expression.ExpressionSequence_1_0 returns IfExpression ExpressionSingle
     * returns IfExpression ExpressionLevel1 returns IfExpression ExpressionLevel2 returns IfExpression
     * ExpressionLevel2.BinaryOperatorExpression_1_0 returns IfExpression ExpressionLevel3 returns IfExpression
     * ExpressionLevel3.BinaryOperatorExpression_1_0 returns IfExpression ExpressionLevel4 returns IfExpression
     * ExpressionLevel4.BinaryOperatorExpression_1_0 returns IfExpression ExpressionLevel5 returns IfExpression
     * ExpressionLevel5.DataMethodCallExpression_1_0 returns IfExpression ExpressionLevel6 returns IfExpression
     * IfExpression returns IfExpression
     *
     * Constraint: (condition=Expression thenClause=Expression elseClause=Expression?)
     */
    ...
    /**
     * Contexts: Statement returns IfStatement Statement.StatementSequence_1_0 returns IfStatement StatementSingle
     * returns IfStatement IfStatement returns IfStatement
     *
     * Constraint: (condition=Expression thenClause=Statement elseClause=Statement?)
     */
    ...
    /**
     * Contexts: ImportLib returns Import
     *
     * Constraint: importURI=POOSL_STRING
     */
    ...
    /**
     * Contexts: InstanceParameter returns InstanceParameter
     *
     * Constraint: (parameter=IDENTIFIER expression=Expression)
     */
    ...
    /**
     * Contexts: InstancePort returns InstancePort
     *
     * Constraint: (instance=[Instance|IDENTIFIER] port=PortReference)
     */
    ...
    /**
     * Contexts: Instance returns Instance
     *
     * Constraint: ( annotations+=Annotation* name=IDENTIFIER classDefinition=IDENTIFIER
    ...
    /**
     * Contexts: Expression returns IntegerConstant Expression.ExpressionSequence_1_0 returns IntegerConstant
     * ExpressionSingle returns IntegerConstant ExpressionLevel1 returns IntegerConstant ExpressionLevel2 returns
     * IntegerConstant ExpressionLevel2.BinaryOperatorExpression_1_0 returns IntegerConstant ExpressionLevel3 returns
     * IntegerConstant ExpressionLevel3.BinaryOperatorExpression_1_0 returns IntegerConstant ExpressionLevel4 returns
     * IntegerConstant ExpressionLevel4.BinaryOperatorExpression_1_0 returns IntegerConstant ExpressionLevel5 returns
     * IntegerConstant ExpressionLevel5.DataMethodCallExpression_1_0 returns IntegerConstant ExpressionLevel6 returns
     * IntegerConstant ExpressionLevel7 returns IntegerConstant ExpressionConstant returns IntegerConstant
     * IntegerConstant returns IntegerConstant NonIDStartWithinStatementExpressionSingle returns IntegerConstant
     * NonIDStartWithinStatementExpressionLevel1 returns IntegerConstant NonIDStartWithinStatementExpressionLevel2
     * returns IntegerConstant NonIDStartWithinStatementExpressionLevel2.BinaryOperatorExpression_1_0 returns
     * IntegerConstant NonIDStartWithinStatementExpressionLevel3 returns IntegerConstant
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns IntegerConstant NonIDStartWithinStatementExpressionLevel7
    ...
    /**
     * Contexts: Statement returns InterruptStatement Statement.StatementSequence_1_0 returns InterruptStatement
     * StatementSingle returns InterruptStatement InterruptStatement returns InterruptStatement
     *
     * Constraint: (normalClause=Statement interruptingClause=StatementSingle)
     */
    ...
    /**
     * Contexts: MessageParameter returns MessageParameter
     *
    ...
    /**
     * Contexts: MessageReceiveSignature returns MessageSignature
     *
     * Constraint: (port=PortReference name=IDENTIFIER (parameters+=MessageParameter parameters+=MessageParameter*)?)
     */
    ...
    /**
     * Contexts: MessageSendSignature returns MessageSignature
     *
     * Constraint: (port=PortReference name=IDENTIFIER (parameters+=MessageParameter parameters+=MessageParameter*)?)
     */
    ...
    /**
     * Contexts: Expression returns NewExpression Expression.ExpressionSequence_1_0 returns NewExpression
     * ExpressionSingle returns NewExpression ExpressionLevel1 returns NewExpression ExpressionLevel2 returns
     * NewExpression ExpressionLevel2.BinaryOperatorExpression_1_0 returns NewExpression ExpressionLevel3 returns
     * NewExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns NewExpression ExpressionLevel4 returns
     * NewExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns NewExpression ExpressionLevel5 returns
     * NewExpression ExpressionLevel5.DataMethodCallExpression_1_0 returns NewExpression ExpressionLevel6 returns
     * NewExpression ExpressionLevel7 returns NewExpression NewExpression returns NewExpression
     * NonIDStartWithinStatementExpressionSingle returns NewExpression NonIDStartWithinStatementExpressionLevel1 returns
     * NewExpression NonIDStartWithinStatementExpressionLevel2 returns NewExpression
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns NewExpression NonIDStartWithinStatementExpressionLevel7 returns
     * NewExpression
     *
     * Constraint: dataClass=IDENTIFIER
     */
    ...
    /**
     * Contexts: Expression returns NilConstant Expression.ExpressionSequence_1_0 returns NilConstant ExpressionSingle
     * returns NilConstant ExpressionLevel1 returns NilConstant ExpressionLevel2 returns NilConstant
     * ExpressionLevel2.BinaryOperatorExpression_1_0 returns NilConstant ExpressionLevel3 returns NilConstant
     * ExpressionLevel3.BinaryOperatorExpression_1_0 returns NilConstant ExpressionLevel4 returns NilConstant
     * ExpressionLevel4.BinaryOperatorExpression_1_0 returns NilConstant ExpressionLevel5 returns NilConstant
     * ExpressionLevel5.DataMethodCallExpression_1_0 returns NilConstant ExpressionLevel6 returns NilConstant
     * ExpressionLevel7 returns NilConstant ExpressionConstant returns NilConstant NilConstant returns NilConstant
     * NonIDStartWithinStatementExpressionSingle returns NilConstant NonIDStartWithinStatementExpressionLevel1 returns
     * NilConstant NonIDStartWithinStatementExpressionLevel2 returns NilConstant
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns NilConstant NonIDStartWithinStatementExpressionLevel7 returns
     * NilConstant
     *
     * Constraint: {NilConstant}
     */
    ...
    /**
     * Contexts: NonIDStartWithinStatementExpressionSingle returns ReturnExpression
    ...
    /**
     * Contexts: NonIDStartWithinStatementExpressionSingle returns BinaryOperatorExpression
     ...
     *
     * Constraint: ( (leftOperand=NonIDStartWithinStatementExpressionLevel2_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel2 rightOperand=ExpressionLevel3) |
     * (leftOperand=NonIDStartWithinStatementExpressionLevel3_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel3
     * rightOperand=ExpressionLevel4) |
     * (leftOperand=NonIDStartWithinStatementExpressionLevel4_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel4
     * rightOperand=ExpressionLevel5) )
     */
    protected void sequence_NonIDStartWithinStatementExpressionLevel2_NonIDStartWithinStatementExpressionLevel3_NonIDStartWithinStatementExpressionLevel4(ISerializationContext context,
            BinaryOperatorExpression semanticObject) {
        genericSequencer.createSequence(context, semanticObject);
    }

    /**
     * Contexts: NonIDStartWithinStatementExpressionLevel3 returns BinaryOperatorExpression
     * NonIDStartWithinStatementExpressionLevel3.BinaryOperatorExpression_1_0 returns BinaryOperatorExpression
     *
     * Constraint: ( (leftOperand=NonIDStartWithinStatementExpressionLevel3_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel3 rightOperand=ExpressionLevel4) |
     * (leftOperand=NonIDStartWithinStatementExpressionLevel4_BinaryOperatorExpression_1_0 name=BinaryOperatorLevel4
     * rightOperand=ExpressionLevel5) )
     */
    ...
    /**
     * Contexts: NonIDStartWithinStatementExpressionLevel4 returns BinaryOperatorExpression
     * NonIDStartWithinStatementExpressionLevel4.BinaryOperatorExpression_1_0 returns BinaryOperatorExpression
     *
     * Constraint: (leftOperand=NonIDStartWithinStatementExpressionLevel4_BinaryOperatorExpression_1_0
     * name=BinaryOperatorLevel4 rightOperand=ExpressionLevel5)
     */
    ...
    /**
     * Contexts: NonIDStartWithinStatementExpressionSingle returns DataMethodCallExpression
     ...
     *
     * Constraint: ( target=NonIDStartWithinStatementExpressionLevel5_DataMethodCallExpression_1_0 onSuperClass?='^'?
     * name=IDENTIFIER (arguments+=Expression arguments+=Expression*)? )
     */
    ...
    /**
     * Contexts: OutputVariable returns OutputVariable
     *
     * Constraint: variable=IDENTIFIER
     */
    ...
    /**
     * Contexts: Statement returns ParStatement Statement.StatementSequence_1_0 returns ParStatement StatementSingle
     * returns ParStatement ParStatement returns ParStatement
     *
     * Constraint: (clauses+=Statement clauses+=Statement*)
     */
    ...
    /**
     * Contexts: Poosl returns Poosl
     *
     * Constraint: ( (imports+=Import | importLibs+=ImportLib)* dataClasses+=DataClass? ((processClasses+=ProcessClass |
     * clusterClasses+=ClusterClass)? dataClasses+=DataClass?)* (clusterClasses+=System (dataClasses+=DataClass |
     * processClasses+=ProcessClass | clusterClasses+=ClusterClass)*)? )
     */
    ...
    /**
     * Contexts: PortDescriptor returns PortReference
     *
     * Constraint: port=IDENTIFIER
     */
    ...
    /**
     * Contexts: PortReference returns PortReference
     *
     * Constraint: port=IDENTIFIER
     */
    ...
    /**
     * Contexts: ProcessClass returns ProcessClass
     *
     * Constraint: ( annotations+=Annotation* name=IDENTIFIER (parameters+=Declaration parameters+=Declaration*)?
     * superClass=IDENTIFIER? (ports+=Port ports+=Port*)? ( (receiveMessages+=MessageReceiveSignature |
     * sendMessages+=MessageSendSignature) receiveMessages+=MessageReceiveSignature?
     * (sendMessages+=MessageSendSignature? receiveMessages+=MessageReceiveSignature?)* )?
     * (instanceVariables+=Declaration instanceVariables+=Declaration*)? initialMethodCall=ProcessMethodCall?
    ...
    /**
     * Contexts: Statement returns ProcessMethodCall Statement.StatementSequence_1_0 returns ProcessMethodCall
     * StatementSingle returns ProcessMethodCall ProcessMethodCall returns ProcessMethodCall
     *
     * Constraint: ( method=IDENTIFIER (inputArguments+=Expression inputArguments+=Expression*)?
    ...
    /**
     * Contexts: ProcessMethod returns ProcessMethod
     *
     * Constraint: ( annotations+=Annotation* name=IDENTIFIER (inputParameters+=Declaration
     * inputParameters+=Declaration*)? (outputParameters+=Declaration outputParameters+=Declaration*)?
     * (localVariables+=Declaration localVariables+=Declaration*)? body=Statement )
     */
    ...
    /**
     * Contexts: Expression returns RealConstant Expression.ExpressionSequence_1_0 returns RealConstant ExpressionSingle
     * returns RealConstant ExpressionLevel1 returns RealConstant ExpressionLevel2 returns RealConstant
     * ExpressionLevel2.BinaryOperatorExpression_1_0 returns RealConstant ExpressionLevel3 returns RealConstant
     * ExpressionLevel3.BinaryOperatorExpression_1_0 returns RealConstant ExpressionLevel4 returns RealConstant
     * ExpressionLevel4.BinaryOperatorExpression_1_0 returns RealConstant ExpressionLevel5 returns RealConstant
     * ExpressionLevel5.DataMethodCallExpression_1_0 returns RealConstant ExpressionLevel6 returns RealConstant
     * ExpressionLevel7 returns RealConstant ExpressionConstant returns RealConstant RealConstant returns RealConstant
     * NonIDStartWithinStatementExpressionSingle returns RealConstant NonIDStartWithinStatementExpressionLevel1 returns
     * RealConstant NonIDStartWithinStatementExpressionLevel2 returns RealConstant
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns RealConstant NonIDStartWithinStatementExpressionLevel7 returns
     * RealConstant
     *
     * Constraint: value=REAL
     */
    ...
    /**
     * Contexts: Statement returns ReceiveStatement Statement.StatementSequence_1_0 returns ReceiveStatement
     * StatementSingle returns ReceiveStatement ReceiveStatement returns ReceiveStatement
     *
     * Constraint: ( portDescriptor=PortDescriptor name=IDENTIFIER (variables+=OutputVariable
     * variables+=OutputVariable*)? receptionCondition=Expression? postCommunicationExpression=Expression? )
     */
    ...
    /**
     * Contexts: Statement returns SelStatement Statement.StatementSequence_1_0 returns SelStatement StatementSingle
     * returns SelStatement SelStatement returns SelStatement
     *
     * Constraint: (clauses+=Statement clauses+=Statement*)
     */
    ...
    /**
     * Contexts: Expression returns SelfExpression Expression.ExpressionSequence_1_0 returns SelfExpression
     * ExpressionSingle returns SelfExpression ExpressionLevel1 returns SelfExpression ExpressionLevel2 returns
     * SelfExpression ExpressionLevel2.BinaryOperatorExpression_1_0 returns SelfExpression ExpressionLevel3 returns
     * SelfExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns SelfExpression ExpressionLevel4 returns
     * SelfExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns SelfExpression ExpressionLevel5 returns
     * SelfExpression ExpressionLevel5.DataMethodCallExpression_1_0 returns SelfExpression ExpressionLevel6 returns
     * SelfExpression ExpressionLevel7 returns SelfExpression SelfExpression returns SelfExpression
     * NonIDStartWithinStatementExpressionSingle returns SelfExpression NonIDStartWithinStatementExpressionLevel1
     * returns SelfExpression NonIDStartWithinStatementExpressionLevel2 returns SelfExpression
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns SelfExpression NonIDStartWithinStatementExpressionLevel7
     * returns SelfExpression
     *
     * Constraint: {SelfExpression}
     */
    ...
    /**
     * Contexts: Statement returns SendStatement Statement.StatementSequence_1_0 returns SendStatement StatementSingle
     * returns SendStatement SendStatement returns SendStatement
     *
     * Constraint: (portDescriptor=PortDescriptor name=IDENTIFIER (arguments+=Expression arguments+=Expression*)?
    ...
    /**
     * Contexts: Statement returns SkipStatement Statement.StatementSequence_1_0 returns SkipStatement StatementSingle
     * returns SkipStatement SkipStatement returns SkipStatement
     *
     * Constraint: {SkipStatement}
     */
    ...
    /**
     * Contexts: Statement returns StatementSequenceRoundBracket Statement.StatementSequence_1_0 returns
     * StatementSequenceRoundBracket StatementSingle returns StatementSequenceRoundBracket BracketStartStatement returns
     * StatementSequenceRoundBracket StatementSequenceRoundBracket returns StatementSequenceRoundBracket
     *
     * Constraint: (statements+=StatementSingle statements+=StatementSingle*)
     */
    ...
    /**
     * Contexts: Statement returns StatementSequence
     *
     * Constraint: (statements+=Statement_StatementSequence_1_0 statements+=StatementSingle+)
     */
    ...
    /**
     * Contexts: Expression returns StringConstant Expression.ExpressionSequence_1_0 returns StringConstant
     * ExpressionSingle returns StringConstant ExpressionLevel1 returns StringConstant ExpressionLevel2 returns
     * StringConstant ExpressionLevel2.BinaryOperatorExpression_1_0 returns StringConstant ExpressionLevel3 returns
     * StringConstant ExpressionLevel3.BinaryOperatorExpression_1_0 returns StringConstant ExpressionLevel4 returns
     * StringConstant ExpressionLevel4.BinaryOperatorExpression_1_0 returns StringConstant ExpressionLevel5 returns
     * StringConstant ExpressionLevel5.DataMethodCallExpression_1_0 returns StringConstant ExpressionLevel6 returns
     * StringConstant ExpressionLevel7 returns StringConstant ExpressionConstant returns StringConstant StringConstant
     * returns StringConstant NonIDStartWithinStatementExpressionSingle returns StringConstant
     * NonIDStartWithinStatementExpressionLevel1 returns StringConstant NonIDStartWithinStatementExpressionLevel2
     * returns StringConstant NonIDStartWithinStatementExpressionLevel2.BinaryOperatorExpression_1_0 returns
     * StringConstant NonIDStartWithinStatementExpressionLevel3 returns StringConstant
     ...
     * NonIDStartWithinStatementExpressionLevel6 returns StringConstant NonIDStartWithinStatementExpressionLevel7
     * returns StringConstant
     *
     * Constraint: value=POOSL_STRING
     */
    ...
    /**
     * Contexts: SwitchExpressionCase returns SwitchExpressionCase
     *
     * Constraint: (value=Expression body=Expression)
     */
    ...
    /**
     * Contexts: Expression returns SwitchExpression Expression.ExpressionSequence_1_0 returns SwitchExpression
     * ExpressionSingle returns SwitchExpression ExpressionLevel1 returns SwitchExpression ExpressionLevel2 returns
     * SwitchExpression ExpressionLevel2.BinaryOperatorExpression_1_0 returns SwitchExpression ExpressionLevel3 returns
     * SwitchExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns SwitchExpression ExpressionLevel4 returns
     * SwitchExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns SwitchExpression ExpressionLevel5 returns
     * SwitchExpression ExpressionLevel5.DataMethodCallExpression_1_0 returns SwitchExpression ExpressionLevel6 returns
     * SwitchExpression SwitchExpression returns SwitchExpression
     *
     * Constraint: (expression=Expression ((cases+=SwitchExpressionCase+ defaultBody=Expression?) |
    ...
    /**
     * Contexts: SwitchStatementCase returns SwitchStatementCase
     *
     * Constraint: (value=Expression body=Statement)
     */
    ...
    /**
     * Contexts: Statement returns SwitchStatement Statement.StatementSequence_1_0 returns SwitchStatement
     * StatementSingle returns SwitchStatement SwitchStatement returns SwitchStatement
     *
     * Constraint: (expression=Expression ((cases+=SwitchStatementCase+ defaultBody=Statement?) |
    ...
    /**
     * Contexts: System returns ClusterClass
     *
     * Constraint: (annotations+=Annotation* (parameters+=Declaration parameters+=Declaration*)? (ports+=Port
     * ports+=Port*)? instances+=Instance* channels+=Channel*)
     */
    ...
    /**
     * Contexts: Expression returns UnaryOperatorExpression Expression.ExpressionSequence_1_0 returns
     * UnaryOperatorExpression ExpressionSingle returns UnaryOperatorExpression ExpressionLevel1 returns
     * UnaryOperatorExpression ExpressionLevel2 returns UnaryOperatorExpression
     * ExpressionLevel2.BinaryOperatorExpression_1_0 returns UnaryOperatorExpression ExpressionLevel3 returns
     * UnaryOperatorExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns UnaryOperatorExpression
     * ExpressionLevel4 returns UnaryOperatorExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns
     * UnaryOperatorExpression ExpressionLevel5 returns UnaryOperatorExpression
     * ExpressionLevel5.DataMethodCallExpression_1_0 returns UnaryOperatorExpression ExpressionLevel6 returns
     * UnaryOperatorExpression UnaryOperatorExpression returns UnaryOperatorExpression
     ...
     *
     * Constraint: (name=OperatorUnary operand=ExpressionLevel7)
     */
    ...
    /**
     * Contexts: Expression returns VariableExpression Expression.ExpressionSequence_1_0 returns VariableExpression
     * ExpressionSingle returns VariableExpression ExpressionLevel1 returns VariableExpression ExpressionLevel2 returns
     * VariableExpression ExpressionLevel2.BinaryOperatorExpression_1_0 returns VariableExpression ExpressionLevel3
     * returns VariableExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns VariableExpression
     * ExpressionLevel4 returns VariableExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns
     * VariableExpression ExpressionLevel5 returns VariableExpression ExpressionLevel5.DataMethodCallExpression_1_0
     * returns VariableExpression ExpressionLevel6 returns VariableExpression ExpressionLevel7 returns
     * VariableExpression VariableExpression returns VariableExpression IDStartWithinStatementExpressionSingle returns
     * VariableExpression IDStartWithinStatementExpressionLevel1 returns VariableExpression
    ...
    /**
     * Contexts: Variable returns Variable
     *
     * Constraint: name=IDENTIFIER
     */
    ...
    /**
     * Contexts: Expression returns WhileExpression Expression.ExpressionSequence_1_0 returns WhileExpression
     * ExpressionSingle returns WhileExpression ExpressionLevel1 returns WhileExpression ExpressionLevel2 returns
     * WhileExpression ExpressionLevel2.BinaryOperatorExpression_1_0 returns WhileExpression ExpressionLevel3 returns
     * WhileExpression ExpressionLevel3.BinaryOperatorExpression_1_0 returns WhileExpression ExpressionLevel4 returns
     * WhileExpression ExpressionLevel4.BinaryOperatorExpression_1_0 returns WhileExpression ExpressionLevel5 returns
     * WhileExpression ExpressionLevel5.DataMethodCallExpression_1_0 returns WhileExpression ExpressionLevel6 returns
     * WhileExpression WhileExpression returns WhileExpression
     *
     * Constraint: (condition=Expression body=Expression)
     */
    ...
    /**
     * Contexts: Statement returns WhileStatement Statement.StatementSequence_1_0 returns WhileStatement StatementSingle
     * returns WhileStatement WhileStatement returns WhileStatement
     *
     * Constraint: (condition=Expression body=Statement)
     */
