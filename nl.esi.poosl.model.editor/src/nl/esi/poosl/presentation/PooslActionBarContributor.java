...
/**
 * This is the action bar contributor for the Poosl model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PooslActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(PooslEditorPlugin.INSTANCE.getString("_UI_PooslEditor_menu"), "nl.esi.pooslMenuID");
